export const Content = {
  ...
  bio: 'I\'m a driven and curious marketer turned web developer with a passion for quality, scalable code that solves interesting problems. After earning an MA in English lit, I spent 6+ years using my writing and design skills in marketing. After years of toying with the idea of coding, I quit my job as a product marketing manager to see if programming was right for me. Coding clicked. Now, I\'m leveraging my critical thinking and problem solving skills to build cool things. On weekends, you can find me sipping cider in the backyard or YouTubing things like \'How to install a tile floor.\' And, you know, doing all those life things like vacuuming and reconciling the budget.',
...
export const ProjectListContent = [
  {
    ...
    technologies: 'Angular, Javascript, Edamam API, Firebase NoSQL database and authentication',
    link: 'https://foodsavorapp-b49fd.firebaseapp.com/'
  },
  {
    image: 'stonewall',
    name: 'Stonewall Wears',
    description: 'This is an e-commerce site where users can browse products and add them to their cart. Users can log-in with their Google account to save their cart for later. This was an independent project completed while at Epicodus.',
    technologies: 'Angular, Javascript, Firebase, Firebase Authentication, Typescript and Git',
...
export const InterestListContent = [
  ...
  },
  {
    label: 'Topics',
    icon: 'favorite',
    list: ['Minimalism', 'Design', 'Financial Independence', 'Photography']
  },
  {
    label: 'Dream Travel',
    icon: 'flight_takeoff',
